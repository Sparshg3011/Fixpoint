...
[![pytest](https://img.shields.io/badge/tests-168_passing-0A9EDC?style=for-the-badge&logo=pytest&logoColor=white)](#results--proof)
...
.venv/bin/python -m pytest        # 168 hermetic tests, no API key needed
